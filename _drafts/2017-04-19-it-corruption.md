...
Я расскажу историю целиком, а вы сами решайте, на чьей вы стороне. Я выступаю
...
что-то взамен. И ITEM и Run-IT заявили мне
...
не сопротивляются этой коррупции, но и потокают ей.

То есть, видимо, Горсовет платит этим двум конференциям. Не деньгами,
а теми услугами, которые может коррумпированная власть оказывать своим холуям.
...
в ней уважаемой фигурой и ничего за это не получу? В то время, как ITEM
заработает.

Это, как минимум, несправедливо. Я предложил ITEM три варианта выхода
из этой ситуации:
...
аргументируя: "Я женщина, у меня дочь".
...
Я выступать на ITEM в этом году не буду. Хотя собирался и доклад готовил
интересный.
...
насквозь коррумпированная власть использует в своих целях. Предлагаю, как
докладчикам, так и слушателям, такие конференции бойкотировать.

Это будет реальным ответом коррупции в стране. Не на словах, а на деле.

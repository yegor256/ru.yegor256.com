...
обязательство не приходить "в чужой огород со своим уставом". Восстания
...
с Российской Федерацией в XX-м.

По всей видимости, природа людей такова, что они не любят когда
ими управляет кто-то со стороны. Они будут терпеть это до тех пор,
пока имеет место явная выгода (например, штаты в США),
либо пока их держат силой (например, республики в СССР).
...
Контр-примерами, в которых тем или иным свособом территории пока удерживаются,
могут служить
...
государствы по типу Косово окончательно сформируются, границы будут
